...
![Build Status: main](https://github.com/obgm/libcoap/actions/workflows/main.yml/badge.svg?branch=main)
![Build Status: develop](https://github.com/obgm/libcoap/actions/workflows/main.yml/badge.svg?branch=develop)
![Static Analysis](https://scan.coverity.com/projects/10970/badge.svg?flat=1)
![Fuzzing Status](https://oss-fuzz-build-logs.storage.googleapis.com/badges/libcoap.svg)
![CIFuzz Status](https://github.com/obgm/libcoap/actions/workflows/cifuzz.yml/badge.svg?branch=develop)
![pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit)
Copyright (C) 2010—2026 by Olaf Bergmann [bergmann@tzi.org](mailto:bergmann@tzi.org) and others
# ABOUT LIBCOAP
...
information related to CoAP, see [https://coap.space](https://coap.space) or
...
[https://libcoap.net](https://libcoap.net).
# PACKAGE CONTENTS
...
Further information can be found at [https://libcoap.net/install.html](https://libcoap.net/install.html)
